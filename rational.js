...
const add = (rat1, rat2) => make((numer(rat1) * denom(rat2) + denom(rat1) * numer(rat2)), (denom(rat1) * denom(rat2)));
const sub = (rat1, rat2) => make((numer(rat1) * denom(rat2) - denom(rat1) * numer(rat2)), (denom(rat1) * denom(rat2)));
